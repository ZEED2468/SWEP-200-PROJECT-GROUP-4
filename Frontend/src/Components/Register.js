  ...
  return (
    ...
    sm:flex sm:flex-col w-[1000px] sm:w-full sm:overflow-hidden
     ...
     ' style={background}>
      ...
      '>
      <img src={topLogo} alt="logo" height="30px" width="100px" className='m-auto relative sm:relative sm:bottom-72
       bottom-14'/>
        <h3 className='text-white text-center font-bold text-4xl relative bottom-0 sm:relative sm:bottom-24 sm:text-6xl
         '>SIGN UP</h3> 
        ...
        gap-2 relative top-14 sm:m-auto sm:flex sm:flex-col sm:gap-28'>
          ...
          right-10 sm:relative sm:right-0 sm:flex sm:flex-col sm:gap-6'>
            ...
            text-xl sm:text-4xl uppercase'>Name:</label>
            <input
              type="text"
              id="name"
              name="name"
          ...
          <div className='flex flex-col gap-2 relative right-10 sm:gap-6
          sm:relative sm:right-0'>
            <label htmlFor="password" className='text-white text-semibold 
            text-xl sm:text-4xl uppercase'>Password:</label>
            <input
      ...
      >
        {showPassword ? (
         ...
         <Link to='/login' target='-blank' className='bg-white text-black border rounded-2xl p-3 w-fit pl-16 pr-16
           m-auto font-bold text-lg hover:bg-[#3FF3FF] relative bottom-5 sm:p-5 sm:pl-14 sm:pr-14 sm:text-4xl'> <button type="submit" >SIGN UP</button>
         </Link>
        </form>
        <p className='text-white text-center mt-12 text-xl
        sm:relative sm:right-0 relative right-5 sm:text-4xl'>Already have an account? <Link to='/login' target='_blank'
