     ...
     b' style={background}>
      <div className='flex flex-col justify-between
       bg-white p-3 border rounded-3xl rounded-r-none
        ...
        <h3 className='text-black font-bold text-4xl relative
         bottom-20 m-auto sm:relative sm:bottom-10 sm:top-7 sm:right-24'>
          FaceEdu</h3>
          <img src={face} alt="faceverify" height="100px" width="200px"  
        className='m-auto sm:relative sm:bottom-12 sm:left-0'/>
      </div>
      ...
      >
        {showPassword ? (
          ...
          <Link to= '/superadmin' className='bg-white text-black border rounded-2xl p-3  w-fit pl-16 pr-16
