...
const Home = () => {
  return (
    <div className=" flex flex-col h-screen">
      ...
      <section
        className="flex flex-row m-auto bg-black w-full
      h-[800px] sm:w-fit sm:flex sm:flex-col"
      >
        <div
          className="flex flex-col w-[400px] justify-between
        p-3 rounded-r-none
        ...
        >
         ...
         bottom-28 m-auto sm:relative sm:bottom-10 sm:top-7 sm:right-24"
          ...
          <p className="text-white text-center relative top-20 mb-8">
            @SWEP200 GROUP 4
          </p>
        </div>
        <div className="bg-white flex flex-col w-[1200px] gap-5">
          <h2
            className="text-center font-bold text-2xl mt-7 tracking-wider"
        ...
        hover:bg-[#3FF3FF] hover:text-black hover:border hover:rounded-3xl pl-15"
            >
              <button className="p-3 pl-20 pr-20">ADMIN</button>
            </Link>
            <Link
              to="/tokenlogin"
              className="bg-black text-white border rounded-3xl
        hover:bg-[#3FF3FF] hover:text-black hover:border hover:rounded-3xl"
            >
              <button className="p-3 pl-20 pr-20">SUPERVISOR</button>
            </Link>
          </div>
        </div>
      </section>
